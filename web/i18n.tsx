...
const zhToEn: Record<string, string> = {
  ...
  /* theme accent presets (theme menu) */
  '主题色': 'Accent color',
  '蓝色（默认）': 'Blue (default)',
  '靛蓝（原版）': 'Indigo (original)',
  '青绿（冷静）': 'Teal (calm)',
  /* table density (theme menu) */
  '表格密度': 'Table density',
  '舒适': 'Comfortable',
  '紧凑': 'Compact',
  '舒适密度': 'Comfortable density',
  '紧凑密度': 'Compact density',
  /* first-run sidebar folding */
  '更多功能': 'More features',
  '更多': 'More',
  /* JSX hardcoded CJK — runtime MutationObserver translates these in EN mode */
  ...
  '待补全': 'Pending',
  /* JSX interpolation text-node fragments */
  '个连接吗？': 'connections?',
  '获取。': 'to fetch.',
  '访问': 'access',
  ...
  'MetAPI 聚合网关': 'MetAPI Aggregate Gateway',
/* VChart canvas charts — chart copy renders to canvas, not DOM (2026-08-01) */
  ...
  /* 2026-08-01: tr()/raw/插值碎片补键（EN 此前显示 Untranslated） */
  '详情': 'Details',
  '不确定': 'Inconclusive',
  '共探测': 'Probed',
  '条': 'items',
  ...
  /* 2026-08-01: 对象字面量值侧中文补键（label:/映射表/option 等——test 此前扫不到，EN 显示 Untranslated） */
  ...
  '今日 —': 'Today —',
  '今日 -': 'Today -',
  // i18n sweep 2026-08-02: high-frequency labels that lived as raw JSX text.
  '模型': 'Model',
  '模型：': 'Model:',
  '重试': 'Retry',
  '客户端': 'Client',
  ...
  '标签：': 'Tags:',
  '倍率：': 'Multiplier:',
  '站点可用性观测': 'Site availability',
  '站点自定义请求头': 'Site custom headers',
  '禁用模型管理': 'Disable model management',
  '探测后模型状态': 'Post-probe model status',
  ...
  /* 2026-08-01: 碎英文垃圾补精确键（短语替换产物人工审查） */
  ...
  'RPM / TPM 为每分钟软准入窗口（）。留空或 0 表示不限；正整数生效。': 'RPM / TPM are per-minute soft admission windows. Empty or 0 means unlimited; positive integers apply.',
