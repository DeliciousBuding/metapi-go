...
| Directory  | Contents                                                                                                                                                                                                                                                                                                                                                                                                             |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `core/`    | Rendering primitives: `data-table-view` (the `<table>`), header, row, pagination, empty state, loading skeleton. Plus the column model — `table-sizing` (the width budget behind the colgroup, and which columns are content-sized), `column-pinning` (sticky edges), `column-label` (a column's human name), `types` (the `ColumnMeta` augmentation) — and the shared cells `badge-list-cell` and `truncated-cell`. |
