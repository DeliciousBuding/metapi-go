...
const isSupportedMode = (mode: ConversationFileTransportMode): boolean =>
  mode !== 'unsupported'

function buildSupportedTypeLabel(
...
export function buildConversationFileAccept(
  capability: ConversationFileCapability
): string {
...
export function buildConversationFileHint(
  capability: ConversationFileCapability
): string {
