/**
 * Downstream key per-key egress proxy helpers.
...
export function normalizeDownstreamKeyProxyUrl(
...
export function parseDownstreamKeyProxyUrl(raw: string | null | undefined): {
  ...
  const supported = SUPPORTED_PROXY_SCHEMES.some((scheme) =>
 ...
 */
export function formatDownstreamKeyProxyIndicator(
  value?: string | null
): string | null {
