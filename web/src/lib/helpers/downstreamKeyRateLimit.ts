/**
 * Downstream key maxRpm / maxTpm helpers.
...
export function normalizeQuotaIntInput(
 ...
 */
export function formatDownstreamKeyMaxRpm(
  value?: number | null
): string | null {
 ...
 */
export function formatDownstreamKeyMaxTpm(
  value?: number | null
): string | null {
  if (!hasDownstreamKeyRateLimit(value)) return null
