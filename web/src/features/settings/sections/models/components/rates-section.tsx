...
export function RatesSection() {
  ...
  return (
    ...
    >
      ...
      <SettingsSubsection title={t('settings.models.rates.accountTable')}>
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead>
                {t('settings.models.rates.columns.account')}
              </TableHead>
              <TableHead>{t('settings.models.rates.columns.site')}</TableHead>
              <TableHead>
                {t('settings.models.rates.columns.channels')}
              </TableHead>
              <TableHead>
                {t('settings.models.rates.columns.unitCost')}
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
      ...
      <SettingsSubsection title={t('settings.models.rates.channelTable')}>
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>
                {t('settings.models.rates.columns.enabled')}
              </TableHead>
