                  ...
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue>
                          {(selected) => {
                            if (!selected) return t('oauth.form.providerPlaceholder')
                            const provider = enabledProviders.find((item) => item.provider === selected)
                            return provider ? provider.label || provider.provider : String(selected)
                          }}
                        </SelectValue>
                      </SelectTrigger>
                    </FormControl>
