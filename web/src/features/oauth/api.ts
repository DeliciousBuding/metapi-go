 ...
 * the connections list so a newly created connection shows up; the start
 * dialog's polling hook (`useOAuthSessionPolling`) kicks its own immediate
 * re-check after a successful submission.
 */
