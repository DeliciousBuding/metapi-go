...
const BRAND_DEFINITIONS: BrandDefinition[] = [
  {
    ...
    rules: [
      ...
      'o4',
      'tts',
    ].map((keyword) => ({ keyword, mode: 'startsWith' })),
  },
  {
    name: 'Anthropic',
    icon: 'claude-color',
    color: '#d4a574',
    rules: [{ keyword: 'claude', mode: 'includes' }],
  },
  {
    name: 'Google',
    icon: 'gemini-color',
    ...
    rules: [
      ...
      .map((keyword) => ({ keyword, mode: 'includes' }))
      .concat([{ keyword: 'veo', mode: 'startsWith' }]),
  },
  {
    name: 'DeepSeek',
    icon: 'deepseek-color',
  ...
  },
  {
    ...
    icon: 'qwen-color',
    color: '#615cf7',
    rules: ['qwen', 'qwq', 'tongyi'].map((keyword) => ({
      keyword,
      mode: 'includes',
    })),
  },
  {
    ...
    icon: 'zhipu-color',
    color: '#3b6cf5',
    rules: ['glm', 'chatglm', 'codegeex', 'cogview', 'cogvideo'].map(
      (keyword) => ({ keyword, mode: 'includes' })
    ),
  },
  {
    name: 'Meta',
    icon: 'meta-color',
    color: '#0668e1',
    rules: ['llama', 'code-llama', 'codellama'].map((keyword) => ({
      keyword,
      mode: 'includes',
    })),
  },
  ...
  },
  {
    ...
    icon: 'moonshot',
    color: '#111827',
    rules: ['moonshot', 'kimi'].map((keyword) => ({
      keyword,
      mode: 'includes',
    })),
  },
  ...
  },
  {
    ...
    icon: 'wenxin-color',
    color: '#2932e1',
    rules: ['ernie', 'eb-'].map((keyword) => ({ keyword, mode: 'includes' })),
  },
  {
    name: '讯飞星火',
    icon: 'spark-color',
    color: '#0070f3',
    rules: ['spark', 'generalv'].map((keyword) => ({
      keyword,
      mode: 'includes',
    })),
  },
  {
    ...
    icon: 'hunyuan-color',
    color: '#00b7ff',
    rules: ['hunyuan', 'tencent-hunyuan'].map((keyword) => ({
      keyword,
      mode: 'includes',
    })),
  },
  {
    ...
    icon: 'doubao-color',
    color: '#3b5bdb',
    rules: [{ keyword: 'doubao', mode: 'includes' }],
  },
  {
    name: 'MiniMax',
    icon: 'minimax-color',
  ...
  },
  {
    ...
    icon: 'cohere-color',
    color: '#39594d',
    rules: ['command', 'c4ai-', 'aya']
      .map((keyword) => ({ keyword, mode: 'includes' }))
      .concat([{ keyword: 'embed-', mode: 'startsWith' }]),
  },
  {
    name: 'Microsoft',
    icon: 'microsoft-color',
    color: '#00bcf2',
    rules: ['microsoft/', 'phi-', 'kosmos']
      .map((keyword) => ({ keyword, mode: 'includes' }))
      .concat([{ keyword: 'phi4', mode: 'segment' }]),
  },
  {
    name: 'xAI',
    icon: 'xai',
    color: '#111827',
    rules: [{ keyword: 'grok', mode: 'includes' }],
  },
  {
    name: '阶跃星辰',
    icon: 'stepfun-color',
  ...
  },
  {
    ...
    icon: 'baichuan-color',
    color: '#0f766e',
    rules: [{ keyword: 'baichuan', mode: 'includes' }],
  },
  {
    name: 'AI21 Labs',
  ...
  },
  {
    ...
    icon: 'ai2-color',
    color: '#0f766e',
    rules: ['allenai', 'olmo'].map((keyword) => ({
      keyword,
      mode: 'includes',
    })),
  },
  ...
  },
  {
    ...
    color: '#8b5cf6',
    rules: ['flux', 'stablediffusion', 'stable-diffusion', 'sdxl']
      .map((keyword) => ({ keyword, mode: 'includes' }))
      .concat([{ keyword: 'sd3', mode: 'startsWith' }]),
  },
  {
    name: 'NVIDIA',
    icon: 'nvidia-color',
    ...
    rules: [
      ...
      .map((keyword) => ({ keyword, mode: 'includes' }))
      .concat([{ keyword: 'nv-', mode: 'startsWith' }]),
  },
  {
    name: 'IBM',
    icon: 'ibm',
    color: '#0f62fe',
    rules: ['ibm/', 'granite'].map((keyword) => ({
      keyword,
      mode: 'includes',
    })),
  },
  {
    ...
    icon: 'baai',
    color: '#111827',
    rules: ['baai/', 'bge-'].map((keyword) => ({ keyword, mode: 'includes' })),
  },
  {
    name: 'ByteDance',
    icon: 'bytedance-color',
    color: '#325ab4',
    rules: ['bytedance', 'seed-oss', 'kolors', 'kwai', 'kwaipilot']
      .map((keyword) => ({ keyword, mode: 'includes' }))
      .concat([
  ...
  },
  {
    ...
    icon: 'internlm-color',
    color: '#1b3882',
    rules: [{ keyword: 'internlm', mode: 'includes' }],
  },
  {
    name: 'Midjourney',
    icon: 'midjourney',
  ...
  },
  {
    ...
    icon: 'jina',
    color: '#111827',
    rules: [{ keyword: 'jina', mode: 'includes' }],
  },
  {
    name: 'Relace',
    icon: 'relace',
    color: '#7c3aed',
    rules: [{ keyword: 'relace', mode: 'includes' }],
  },
  {
    name: 'Arcee',
    icon: 'arcee-color',
    color: '#2563eb',
    rules: ['arcee-ai', 'arcee'].map((keyword) => ({
      keyword,
      mode: 'includes',
    })),
  },
  {
    ...
    icon: 'aionlabs-color',
    color: '#0f766e',
    rules: ['aion-labs', 'aionlabs'].map((keyword) => ({
      keyword,
      mode: 'includes',
    })),
  },
  {
    ...
    color: '#2563eb',
    rules: [{ keyword: 'deepcogito', mode: 'includes' }],
  },
  {
    name: 'Essential AI',
    icon: 'essentialai-color',
    color: '#0f172a',
    rules: [{ keyword: 'essentialai', mode: 'includes' }],
  },
  {
    name: 'Inception',
    icon: 'inception',
    color: '#7c3aed',
    rules: [{ keyword: 'inception', mode: 'includes' }],
  },
  {
    name: 'Inflection',
    icon: 'inflection',
    color: '#1d4ed8',
    rules: [{ keyword: 'inflection', mode: 'includes' }],
  },
  {
    name: 'Liquid AI',
    icon: 'liquid',
  ...
  },
  {
    ...
    icon: 'longcat-color',
    color: '#f97316',
    rules: [{ keyword: 'longcat', mode: 'includes' }],
  },
  {
    name: 'Morph',
    icon: 'morph-color',
  ...
  },
  {
    ...
    icon: 'nousresearch',
    color: '#111827',
    rules: [{ keyword: 'nousresearch', mode: 'includes' }],
  },
  {
    name: 'Upstage',
    icon: 'upstage-color',
    color: '#2563eb',
    rules: [{ keyword: 'upstage', mode: 'includes' }],
  },
  {
    name: 'Xiaomi MiMo',
    icon: 'xiaomimimo',
  ...
  },
  {
    ...
    color: '#f59e0b',
    rules: [{ keyword: 'sensenova', mode: 'includes' }],
  },
  {
    name: 'OpenRouter',
    icon: 'openrouter',
    color: '#7c3aed',
    rules: ['openrouter', 'openrouter-'].map((keyword) => ({
      keyword,
      mode: 'includes',
    })),
  },
  {
    ...
    icon: 'groq',
    color: '#111827',
    rules: [{ keyword: 'groq', mode: 'includes' }],
  },
  {
    name: 'DeepInfra',
    icon: 'deepinfra-color',
    color: '#4f46e5',
    rules: [{ keyword: 'deepinfra', mode: 'includes' }],
  },
  {
    name: 'Fireworks',
    icon: 'fireworks-color',
    color: '#fb7185',
    rules: ['fireworks-ai', 'fireworks'].map((keyword) => ({
      keyword,
      mode: 'includes',
    })),
  },
  {
    ...
    color: '#7c3aed',
    rules: ['together.ai', 'together'].map((keyword) => ({
      keyword,
      mode: 'includes',
    })),
  },
  {
    ...
    color: '#111827',
    rules: [{ keyword: 'replicate', mode: 'includes' }],
  },
  {
    name: 'Cerebras',
    icon: 'cerebras-brand-color',
    color: '#0f766e',
    rules: [{ keyword: 'cerebras', mode: 'includes' }],
  },
  {
    name: '百炼',
    icon: 'bailian-color',
    color: '#7c3aed',
    rules: ['bailian', 'dashscope'].map((keyword) => ({
      keyword,
      mode: 'includes',
    })),
  },
  ...
  switch (rule.mode) {
    ...
    case 'startsWith':
      return (
        ...
        context.candidates.some((candidate) =>
          candidate.startsWith(rule.keyword)
        )
      )
    case 'segment':
    ...
    case 'boundary': {
      const pattern = new RegExp(
        `(^|[/:_\\-\\s])${escapeRegExp(rule.keyword)}(?=$|[/:_\\-\\s])`
      )
      return (
