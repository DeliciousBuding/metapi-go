...
/**
 * DEV-only shell chrome mock for interim visual acceptance without backend auth.
            ...
            <div data-testid="shell-mock-dashboard">
              <div className="page-header">
                <div>
                  ...
                  <p className="page-subtitle">Mock shell · no API · demo fixtures</p>
                </div>
              ...
              <Card title="Traffic trend" description="Token-only sparkline mock for shell composition.">
...
/**
 * Dev/visual acceptance gallery for design-system primitives.
 * Routed at /__design__ behind DEV or localStorage.metapi_design_gallery === '1'.
 * Shell chrome mock provides CI-friendly Dashboard/Sites/Settings composition
  ...
  return (
    <div className="ds-gallery" data-testid="design-system-gallery">
      <header className="ds-gallery__header">
        <div>
          <p className="ds-gallery__eyebrow">Design system</p>
      ...
      <section className="ds-gallery__section" aria-labelledby="ds-empty">
        <h2 id="ds-empty" className="ds-gallery__section-title">Empty / error states</h2>
        <div className="ds-gallery__grid">
