...
/** Shared first-run / empty-well next step. */
    ...
    <div className="animate-fade-in">
      ...
      >
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          {/* J1: shareable dashboard snapshot PNG */}
      ...
      {/* B1: severity-ranked attention panel */}
      <div
      ...
      {/* C1: unified scheduler run history */}
      <div
        className="chart-panel-enter animate-slide-up stagger-6"
        style={{ marginBottom: 24 }}
      >
      ...
      >
        ...
        {/* A1: daily balance trend card */}
        <div className="chart-panel-enter animate-slide-up stagger-7">
          <Suspense fallback={<ChartFallback height={320} />}>
            <BalanceHistoryChart days={30} />
          </Suspense>
        </div>
        {/* A3: income vs consumption card */}
        <div className="chart-panel-enter animate-slide-up stagger-7">
          <Suspense fallback={<ChartFallback height={320} />}>
      ...
      {/* A2: model cost + latency chart gallery */}
      <div
        style={{
          display: "grid",
          gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr",
