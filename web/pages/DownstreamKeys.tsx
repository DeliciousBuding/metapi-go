...
type DownstreamApiKeyItem = {
  ...
  usedRequests: number;
  /** Optional soft RPM window; null = unlimited. */
  maxRpm?: number | null;
  /** Optional soft TPM window; null = unlimited. */
  maxTpm?: number | null;
  ...
  /** Per-key IP allowlist; newline/comma-separated; null/empty = unrestricted. */
  ipAllowlist?: string | null;
  /** Per-key IP blocklist; blocklist wins; null/empty = no denies. */
...
export default function DownstreamKeys() {
  ...
  // the raw key — only keyMasked + non-sensitive accounting fields.
