...
// Inline row speed-test state. Mirrors the Dashboard per-site probe.
...
export default function Sites() {
  ...
  // Inline row speed test: client-side latency probe to site.url/v1/models,
  ...
  // I1: tag filter + per-site tag editor.
  ...
  return (
    <div className="animate-fade-in">
      ...
      {/* defer weight-formula education until at least one site exists so EmptyState CTA stays primary */}
      {sites.length > 0 ? (
          ...
          <ResponsiveFormGrid>
            ...
            <div style={{ display: 'flex', gap: 8, flexDirection: isMobile ? 'column' : 'row' }}>
              <input
                ...
                placeholder="准确主站点 URL（面板/登录/签到地址，如 https://example.com）"
                value={form.url}
