...
| Latest release | **[v0.8.45](https://github.com/DeliciousBuding/metapi-go/releases/tag/v0.8.45)** (2026-07-20); GHCR remains `ghcr.io/tokendancelab/metapi-go` |
...
| Production pin (ops) | hk3 `td-metapi` **0.8.45 Up healthy** since 2026-07-20; Azure PG pool/role **1/1**; `restart=no` |
...
| Open issues / PRs | [#557](https://github.com/DeliciousBuding/metapi-go/issues/557) · [#558](https://github.com/DeliciousBuding/metapi-go/issues/558) · historical open PR [#542](https://github.com/DeliciousBuding/metapi-go/pull/542) |
...
| Historical branch | `origin/codex/metapi-regex-crash`; fix already reapplied on `master`, PR #542 remains open |
