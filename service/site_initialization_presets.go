...
var siteInitializationPresets = []SiteInitializationPreset{
	{
		...
		Description:               "OpenAI-compatible entry for Aliyun CodingPlan. Add an API key first, then add the recommended models to complete initialization.",
		Platform:                  "openai",
	...
	},
	{
		...
		ProviderLabel:             "Aliyun CodingPlan",
		Description:               "Claude-compatible entry for Aliyun CodingPlan. Add an API key first, then add the recommended models to complete initialization.",
		Platform:                  "claude",
	...
	},
	{
		...
		Label:                     "Zhipu Coding Plan / OpenAI",
		ProviderLabel:             "Zhipu Coding Plan",
		Description:               "OpenAI-compatible entry for Zhipu Coding Plan. Add an API key first, then add common GLM coding models.",
		Platform:                  "openai",
	...
	},
	{
		...
		Label:                     "Zhipu Coding Plan / Claude",
		ProviderLabel:             "Zhipu Coding Plan",
		Description:               "Claude-compatible entry for Zhipu Coding Plan. As this endpoint also serves as a general compatible entry, only a manual preset is provided here; URL-based auto-detection is not enforced.",
		Platform:                  "claude",
	...
	},
	{
		...
		Description:               "OpenAI-compatible entry for DeepSeek. Add an API key directly, then add the official common coding models first.",
		Platform:                  "openai",
	...
	},
	{
		...
		ProviderLabel:             "DeepSeek",
		Description:               "Anthropic-compatible entry for DeepSeek, convenient for direct use with Claude Code-style tools.",
		Platform:                  "claude",
	...
	},
	{
		...
		Description:               "OpenAI-compatible entry for Moonshot. Kimi coding and agent models are recommended.",
		Platform:                  "openai",
	...
	},
	{
		...
		ProviderLabel:             "Moonshot / Kimi",
		Description:               "Anthropic-compatible entry for Moonshot, convenient for Claude Code and similar tools to use Kimi.",
		Platform:                  "claude",
	...
	},
	{
		...
		Description:               "OpenAI-compatible entry for MiniMax. Add an API key directly, then add common M2 coding models.",
		Platform:                  "openai",
	...
	},
	{
		...
		ProviderLabel:             "MiniMax",
		Description:               "Anthropic-compatible entry for MiniMax, suitable for Claude Code and other coding tools.",
		Platform:                  "claude",
	...
	},
	{
		...
		Description:               "OpenAI-compatible entry for ModelScope API-Inference, convenient for connecting common open-source coding models.",
		Platform:                  "openai",
	...
	},
	{
		...
		ProviderLabel:             "ModelScope",
		Description:               "Claude-compatible entry for ModelScope API-Inference, convenient for Claude Code-style tools.",
		Platform:                  "claude",
	...
	},
	{
		...
		Label:                     "Doubao Coding Plan / OpenAI",
		ProviderLabel:             "Doubao Coding Plan",
		Description:               "OpenAI-compatible entry for Volcano Ark Coding Plan. ark-code and Doubao coding models are recommended.",
		Platform:                  "openai",
