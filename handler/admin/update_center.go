...
// - deploy/rollback/task stream are honest 501 known limitations (no stub task ids / fake SSE)
...
// Local check only — no remote registry polling.
...
// Deploy/rollback remain 501 known limitations regardless of echoed values.
...
// Remote binary/Helm deploy is out of process scope — honest 501 known limitation.
...
// Remote rollback is out of process scope — honest 501 known limitation.
...
// No deploy/rollback task registry exists — honest 501 known limitation (no fake SSE done).
