...
// Resolution/upload remains a known limitation: TS inlines local file refs; Go proxies
...
// limitation explicit: no local multi-tenant vault, no silent empty success.
...
// Known limitation: there is no local vault / durable fetch. Returns
