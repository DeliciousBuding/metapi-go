...
// completions), Anthropic Claude /v1/messages (), OpenAI
// /v1/responses (+ /compact) (), and Gemini generateContent /
// streamGenerateContent (). count_tokens / countTokens and other
// surfaces stay out.
