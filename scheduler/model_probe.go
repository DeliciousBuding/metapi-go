...
// batch model verification, It reuses the injected
...
// Used by admin /api/models/probe and site probe-now.
...
// Caps the batch so default-on budgets stay small (out of scope: every model).
